...
const Search = () => {
  return (
    <form className="flex bg-input-background px-1.25 py-1.75 gap-3 mt-15 rounded-lg w-full flex-wrap">
      <div className="flex gap-5">
        ...
        <Image height={24} width={24} src="/icons/back-forth-icon.svg" alt="" />
